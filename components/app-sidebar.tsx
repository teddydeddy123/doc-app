        ...
        <SidebarHeader className="border-none p-0 pb-4 text-white">
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              <span className="text-base font-semibold text-white">DoKKo</span>
                ...
                {menuItems.map((item) => (
                  <SidebarMenuItem key={item.title} className="relative">
                    ...
                    >
                      ...
                      >
                        <div
                          className={`flex items-center justify-center bg-white rounded-xl ${state === "collapsed" ? "p-[5px]" : "size-8"} text-sky-700 shadow-sm group-data-[active=true]/menu-item:bg-[#155dfc] group-data-[active=true]/menu-item:text-white group-data-[collapsible=icon]:w-fit group-data-[collapsible=icon]:rounded-full`}
                        >
